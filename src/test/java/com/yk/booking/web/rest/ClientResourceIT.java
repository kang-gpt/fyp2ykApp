...
import static com.yk.booking.domain.ClientAsserts.*;
...
class ClientResourceIT {
    ...
    private static final Instant DEFAULT_DOB = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    private static final Instant UPDATED_DOB = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final ClientTier DEFAULT_TIER = ClientTier.PLATINUM;
    private static final ClientTier UPDATED_TIER = ClientTier.GOLD;
