...
const adminMenuItems = () => (
  <>
    <MenuItem icon="home" to="/admin">
      <Translate contentKey="global.menu.admin.homepage">Homepage</Translate>
    </MenuItem>
    ...
    <MenuItem icon="calendar-check" to="/admin/manage-bookings">
      <Translate contentKey="global.menu.admin.manageBookings">Manage Bookings</Translate>
    </MenuItem>
