...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CLIENTTIER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CLIENTTIER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CLIENTTIER actions', async () => {
      const arg = { id: 14825 };
    ...
    it('dispatches UPDATE_CLIENTTIER actions', async () => {
      const arg = { id: 14825 };
    ...
    it('dispatches PARTIAL_UPDATE_CLIENTTIER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CLIENTTIER actions', async () => {
      const arg = 42666;
