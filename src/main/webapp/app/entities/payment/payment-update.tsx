  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="ykApp.payment.home.createOrEditLabel" data-cy="PaymentCreateUpdateHeading">
            <Translate contentKey="ykApp.payment.home.createOrEditLabel">Create or edit a Payment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('ykApp.payment.amount')}
                id="payment-amount"
                name="amount"
                data-cy="amount"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('ykApp.payment.paymentDate')}
              ...
              />
              <ValidatedField
                label={translate('ykApp.payment.status')}
                id="payment-status"
                name="status"
                data-cy="status"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('ykApp.payment.qrCodeUrl')}
                id="payment-qrCodeUrl"
                name="qrCodeUrl"
                data-cy="qrCodeUrl"
                type="text"
              />
              <ValidatedField
                label={translate('ykApp.payment.transactionId')}
                id="payment-transactionId"
                name="transactionId"
                data-cy="transactionId"
                type="text"
              />
              <ValidatedField id="payment-user" name="user" data-cy="user" label={translate('ykApp.payment.user')} type="select">
                <option value="" key="0" />
                {users
