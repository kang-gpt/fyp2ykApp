...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './sport.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPORT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPORT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPORT actions', async () => {
      const arg = { id: 25575 };
    ...
    it('dispatches UPDATE_SPORT actions', async () => {
      const arg = { id: 25575 };
    ...
    it('dispatches PARTIAL_UPDATE_SPORT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPORT actions', async () => {
      const arg = 42666;
